...
@section('content')
    <div class="register">
        <div class="container">
            <div class="header">
                <h1>Créer une boutique sur admar.ma gratuitement</h1>
                <div class="connection-with">
                    <div class="facebook"><i class="fa-brands fa-facebook"></i>Connecter avec Facebook</div>
                    <div class="google"><i class="fa-brands fa-google"></i> Connecter ave Google</div>
                </div>
            </div>
            <div class="dvider">OU</div>
            {{ $errors }}
            <form action="{{ route('register.user') }}" class="register-form">
                <h5 class="text-left"><strong>Vous étes</strong></h3>
                    <div class="type">
                        <div class="option">
                            <input type="radio" value="0" name="type" checked>
                            <label for="type">Gratuite</label>
                        </div>
                        <div class="option">
                            <input type="radio" value="1" name="type">
                            <label for="type">Premium</label>
                        </div>
                    </div>
                    ...
                    <label for="name">Description (Obligatoire)</label>
                    <div class="input">
                        <div class="prifix"><i class="fa-solid fa-user"></i></div>
                        <input type="tetx" name="name" placeholder="votre Nom"
                            class="@error('name') is-invalid @enderror" required>
                    ...
                    <label for="name">Categorié (Obligatoire)</label>
                    <select id="category_id" name="category_id">
                        @if (ParentCategories() && $categories->count() > 0)
                            <option value="" selected disabled>Choisissez une categorié
                            </option>
                ...
                @enderror
                    ...
                    @enderror
                    <label for="city">Adresse (Obligatoire)</label>
                    <div class="input">
                        <input type="text" name="address" placeholder="Tapez voutre adresse">
                    </div>
                    @error('city')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                    ...
                    <div class="input">
                        ...
                        <input type="email" name="email" placeholder="nom@example.com"
                    ...
                    <div class="input">
                        <div class="prifix"><i class="fa-solid fa-envelope"></i></div>
                        <input type="email" name="email-confirmation" placeholder="Vérifiez votre adresse email"
                    ...
                    <div class="input">
                        ...
                        <input type="password" name="password" placeholder="Email de votre magasin"
                    ...
                    <div class="input">
                        <div class="prifix"><i class="fa-solid fa-lock"></i></div>
                        <input type="password" placeholder="Email de votre magasin" name="password_confirmation" required
