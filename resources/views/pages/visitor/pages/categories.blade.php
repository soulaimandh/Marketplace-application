            ...
            <div class="container">
                <div class="wrapper">
                    <div class="chooses">
                        ...
                        <span class="icon row justify-content-center active"><i class="fas fa-list col-12"></i><span
                                class="col-12 text-center">LISTE</span></span>
                        <span class="icon row justify-content-center"><i
                        ...
                        <div class="menu">
                            <div class="box">
                                ...
                                <form action="">
                                    <div class="input distance-input">
                                        ...
                                        <input class="distance" type="text" value="100" name="distance"
                                            >
                                    </div>
                                    <input type="range" class="range" max="1000000" min="10" name="distance-progress">
                            ...
                            <div class="box">
                                ...
                                <form action="" class="multi-range-form">
                                    <div class="input">
                                        <label for="">Dhs</label>
                                        <input type="text" placeholder="Prix Min" name="prix-max" >

                                    </div>
                                    <div class="input">
                                        <label for="">Dhs</label>
                                        <input type="text" placeholder="Prix Max" name="prix-min" >
                                    </div>
                                    <div class="multi-range">
                                        <input type="range" class="range" min="0" max="50" value="20" id="min">
                                        <input type="range" class="range" min="0" max="50" value="25" id="max">
                                    </div>
