...
@section('content')
    <div class="page" id="page">
        <div class=new-admin id="new-admin">
            <div class="page-top">
                <div class="title">Modifié la Catégorie</div>
            ...
            <div class="page-body" id="page-body">
                ...
                <div class="body-content" id="body-content">
                    ...
                    <form class="form" action="{{ route('categories.update', $category->id) }}" method="POST"
                        ...
                        <div class="section">
                            <div class="title">{{ __('admin/globale.category_info') }}</div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="field">
                                ...
                                <div class="field">
                                    ...
                                    <select id="parent_id" name="parent_id">
                                        @if (Parentcategories() && Parentcategories()->count() > 0)
                                            <option value="" selected disabled>Choissisez la catégorie père</option>
