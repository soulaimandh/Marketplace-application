...
@section('content')
    <div class="page" id="page">
        <div class=new-admin id="new-admin">
            <div class="page-top">
                <div class="title">{{__('admin/globale.edit')}}{{__('admin/globale.post')}}</div>
                    ...
                    <form class="form" action="{{ route('posts.update', $post->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            <div class="text-center">
                                <img src="{{ $post->thumbnail() }}" style="border-radius: 20px;max-width:100%; height:200px" class="height-250"
                                    alt="section image">
                            </div>
                        </div>
                        <div class="logo">
                                ...
                                <div class="field">
                                    ...
                                    <select id="category_id" name="category_id">
                                        @if ($categories && $categories->count() > 0)
                                            <option value="" selected disabled>{{__('admin/globale.choose_category')}}</option>
